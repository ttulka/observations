  ...
  static Future<Database> _connectDatabase() async {
    ...
    final Database db = await openDatabase(
      ...
      onCreate: (db, version) async {
        ...
        await db.execute(r'CREATE INDEX students_deletedIdx ON students (deleted)');
        await db.execute(r'CREATE INDEX students_classroomIdx ON students (classroomId)');
        await db.execute(
        ...
        await db.execute(r'CREATE INDEX categories_deletedIdx ON categories (deleted)');
        await db.execute(
        ...
        await db.execute("INSERT INTO properties VALUES ('printing_convert_html', '1')");
...
Future<void> generateFakeData(Database db) async {
  ...
  await db.execute("INSERT INTO classrooms VALUES ('$bartsClassId', '4A', 'Bart\'\'s class', '${now.year}', FALSE)");
  await db.execute("INSERT INTO students VALUES ('${const Uuid().v4()}', 'Simpson', 'Bart', '$bartsClassId', FALSE)");
  await db.execute("INSERT INTO students VALUES ('${const Uuid().v4()}', 'Muntz', 'Nelson', '$bartsClassId', FALSE)");
  await db.execute("INSERT INTO students VALUES ('${const Uuid().v4()}', 'Prince', 'Martin', '$bartsClassId', FALSE)");
  await db.execute(
      "INSERT INTO students VALUES ('${const Uuid().v4()}', 'Van Houten', 'Milhouse', '$bartsClassId', FALSE)");
  await db.execute("INSERT INTO students VALUES ('${const Uuid().v4()}', 'Borton', 'Wendell', '$bartsClassId', FALSE)");
  await db.execute("INSERT INTO students VALUES ('${const Uuid().v4()}', 'Clark', 'Lewis', '$bartsClassId', FALSE)");
  await db
      .execute("INSERT INTO students VALUES ('${const Uuid().v4()}', 'Mackleberry', 'Sherri', '$bartsClassId', FALSE)");
  await db
      .execute("INSERT INTO students VALUES ('${const Uuid().v4()}', 'Mackleberry', 'Terri', '$bartsClassId', FALSE)");
  final lisasClassId = const Uuid().v4();
  await db.execute("INSERT INTO classrooms VALUES ('$lisasClassId', '3A', 'Lisa\'\'s class', '${now.year}', FALSE)");
  await db.execute("INSERT INTO students VALUES ('${const Uuid().v4()}', 'Simpson', 'Lisa', '$lisasClassId', FALSE)");
  await db.execute("INSERT INTO students VALUES ('${const Uuid().v4()}', 'Wiggum', 'Ralph', '$lisasClassId', FALSE)");
  await db.execute("INSERT INTO students VALUES ('${const Uuid().v4()}', 'Powell', 'Janey', '$lisasClassId', FALSE)");
  await db.execute("INSERT INTO students VALUES ('${const Uuid().v4()}', 'Taylor', 'Allison', '$lisasClassId', FALSE)");
  await db.execute("INSERT INTO students VALUES ('${const Uuid().v4()}', 'Whitney', 'Alex', '$lisasClassId', FALSE)");
  await db.execute("INSERT INTO students VALUES ('${const Uuid().v4()}', 'Weasel', 'Black', '$lisasClassId', FALSE)");
  await db.execute("INSERT INTO students VALUES ('${const Uuid().v4()}', 'Weasel', 'Yellow', '$lisasClassId', FALSE)");
}
