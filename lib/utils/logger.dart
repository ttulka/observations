...
class Logger {
  ...
  static Future<void> debug(String message, [Object? e]) async {
    if (!kReleaseMode) await _logIt(stdout, _composeMessage('DEBUG', message, e));
  }

  static Future<void> info(String message, [Object? e]) => _logIt(stdout, _composeMessage('INFO', message, e));

  static Future<void> error(String message, [Object? e]) => _logIt(stderr, _composeMessage('ERROR', message, e));
